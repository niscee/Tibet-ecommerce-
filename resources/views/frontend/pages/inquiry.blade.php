                ...
                <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control"  name="category">
                            <option value="{{$ordercata->id}}">{{$ordercata->category}}</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" name="product">
                            ...
                            <option value="{{$orderpro->proname}} "> {{$orderpro->proname}} </option>
                        </select>
                    </div>
                </div>

                <div class="form-group required">
                    <label class="col-sm-2 " for="input-payment-country"> Products Code</label>
                    <div class="col-sm-10">
                        <select class="form-control" name="product_code">

                            <option value="{{$orderpro->procode}} "> {{$orderpro->procode}} </option>
                        </select>
                    </div>
                </div>
