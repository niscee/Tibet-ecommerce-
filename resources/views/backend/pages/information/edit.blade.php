            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-6" style="">
                    <div class="x_panel"  style="background-color:#00a65a;color:white;">
                        ...
                        <div class="x_title">
                            <h2><i class="fa fa-tag"></i>&nbsp; Edit Site Information </h2>&nbsp;{{--&nbsp;<a href="{{route('admin-information')}}"><button class="btn btn-default btn btn-md">Back</button></a>--}}<a href="{{route('admin-information')}}"><i class="fa fa-arrow-circle-left" style="font-size:20px;color:white">&nbsp;<span style="font-size: 18px;color:white">BACK</span></i></a></span>
                        ...
                        <div class="x_content" {{--style="background-color: ghostwhite"--}}>
                            ...
                            <form class="form-horizontal form-label-left" method="post"
                                  action="{{route('admin-information-edit-action',['id'=>$datas->id])}}">
                                {{csrf_field()}}
                                ...
                                <div class="form-group  col-md-6">
                                    ...
                                    <input type="text" class="form-control" required name="title" id="title" value="{{$datas->title}}">
                                </div>

                                <div class="form-group  col-md-6">
                                    <label for="inputAddress">Slug:</label>
                                    <input type="text" class="form-control" required name="slug" id="slug" value="{{$datas->slug}}" readonly>
                                </div>
                                <br>
