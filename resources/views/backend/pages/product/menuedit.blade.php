        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-6">
                ...
                <div class="x_panel" style="background-color:#00a65a;color:navajowhite;margin-left:200px;">
                    ...
                    <div class="x_title">
                        <h2><i class="fa fa-tag"></i>&nbsp;Update Category</h2>
                    ...
                    <div class="x_content" {{--style="background-color:ghostwhite; height:150px;"--}}>
                        ...
                        <br>
                        <form action="{{route('admin-menu-edit-action',['id'=>$datas->id])}}" method="post">
                            {{csrf_field()}}
                            <div class="form-group col-md-12">
                                <label for="inputEmail4">Category:</label>
                                <input type="text" class="form-control category" required name="category" value="{{$datas->category}}" >
                            </div>
